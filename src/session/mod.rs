...
//! Compaction appends a compact event rather than rewriting older records.
//!
...
pub enum SessionEvent {
    ...
    /// reset to this compacted message list.
    Compact {
...
impl Manager {
    ...
    /// earlier append-only events for debugging and audit.
    ///
    /// # Errors
    ///
    ...
    /// Load the raw append-only event stream.
    ///
